...
namespace MOAR
{
	public class Building_DamagedPsychicEmanator : Building_CrashedShipPart
	{
		...
		public override void SpawnSetup(Map map, bool respawningAfterLoad)
		{
			...
			this.ticksToInsanityPulse = Building_DamagedPsychicEmanator.InsanityPulseInterval.RandomInRange;
